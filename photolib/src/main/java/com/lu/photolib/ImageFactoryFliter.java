...
//			refreshBlockBg();
	...
	private void initFilterList() {
		...
		FilterItem filterItem_1 = new FilterItem(FilterType.DEFAULT, "默认");
		FilterItem filterItem_2 = new FilterItem(FilterType.LOMO, "LOMO");
		FilterItem filterItem_3 = new FilterItem(FilterType.CHUN_ZHEN, "纯真");
		FilterItem filterItem_4 = new FilterItem(FilterType.ZHONG_CAI, "重彩");
		FilterItem filterItem_5 = new FilterItem(FilterType.wei_ye_lai, "淡雅");
		FilterItem filterItem_6 = new FilterItem(FilterType.DAN_YAN, "维也纳");
		FilterItem filterItem_7 = new FilterItem(FilterType.CU, "酷");
		FilterItem filterItem_8 = new FilterItem(FilterType.CHUN_HOU, "浓厚");
