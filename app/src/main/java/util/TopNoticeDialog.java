...
public class TopNoticeDialog {
    ...
    private static void createDialog(Context context, CharSequence text, TipType type) {
        ...
        Debug.d(TopNoticeDialog.class, "ActivityNotFinished");
...
//        Debug.d(TopNoticeDialog.class,"...............setNull:"+setNull);
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
//            if (dialog.getWindow() != null && dialog.getWindow().getDecorView().isAttachedToWindow()) {
